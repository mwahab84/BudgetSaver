...
namespace BudgetSaver.Droid
{
    [Activity(Label = "Ezay Nwafar", Icon = "@drawable/icon", Theme = "@style/MyTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
